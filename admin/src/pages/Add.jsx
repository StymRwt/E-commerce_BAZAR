  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <div className='w-full'>
        ...
        <input onChange={(e)=>setName(e.target.value)} value={name} className='w-full max-w-[500px]' type="text" placeholder=' Name' required />
      </div>

      <div className='w-full'>
        <p className='mb-2'>Product description</p>
        <textarea  onChange={(e)=>setDescription(e.target.value)} value={description} className='w-full max-w-[500px]' type="text" placeholder=' Write content here' required />
      </div>
      ...
      <button className='w-28 py-3 mt-4 bg-black text-white rounded-2xl' type='submit'>ADD</button>
